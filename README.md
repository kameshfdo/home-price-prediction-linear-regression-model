...
```
ssh -i "C:\Users\Viral\.ssh\home.pem" ubuntu@ec2-3-133-88-210.us-east-2.compute.amazonaws.com
```
3. nginx setup
...
6.  After copying code on EC2 server now we can point nginx to load our property website by default. For below steps,
    ...
    server {
	    listen 80;
            server_name bhp;
            root /home/ubuntu/HomePrices/client;
            index app.html;
            location /api/ {
                 rewrite ^/api(.*) $1 break;
...
sudo pip3 install -r /home/ubuntu/HomePrices/server/requirements.txt
python3 /home/ubuntu/HomePrices/client/server.py
```
